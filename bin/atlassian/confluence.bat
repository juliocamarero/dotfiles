...
rem   java -jar "%dirPath%"/lib/confluence-cli-2.6.0.jar --server http://my-server --user automation --password automation %*

java -jar "%dirPath%"/lib/confluence-cli-2.6.0.jar %*
